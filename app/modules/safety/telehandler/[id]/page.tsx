...
// Telehandler Type checkboxes
const telehandlerTypeSchema = z.object({
  telehandler: z.boolean().default(false),
  forklift: z.boolean().default(false),
});

const telehandlerFormSchema = z.object({
  formName: z.string().default("Telehandler/Forklift Pre-Use Inspection"),
  ...
  formData: z.object({
    ...
    powerOffChecks: z.object({
      ...
      windowsGlassDoors: checkboxItemSchema,
      hoodCoverPanels: checkboxItemSchema,
      airFilterIndicator: checkboxItemSchema,
      counterweightBolts: checkboxItemSchema,
      liftingAttachments: checkboxItemSchema,
      boomSectionsDamage: checkboxItemSchema,
      boomAngleIndicator: checkboxItemSchema,
      ropsCab: checkboxItemSchema,
      frameLevelIndicator: checkboxItemSchema,
      seatbelt: checkboxItemSchema,
    ...
    powerOnChecks: z.object({
      ...
      fuelLevel: checkboxItemSchema,
      hornWarningDevices: checkboxItemSchema,
      boomCarriage: checkboxItemSchema,
      liftingAttachment: checkboxItemSchema,
      driveForwardReverse: checkboxItemSchema,
      steerLeftRight: checkboxItemSchema,
      frameLevel: checkboxItemSchema,
      outriggers: checkboxItemSchema,
      otherFunctionControl: checkboxItemSchema,
      braking: checkboxItemSchema,
      serviceDeClutch: checkboxItemSchema,
      parking: checkboxItemSchema,
      otherPowerOn: checkboxItemSchema,
    }),

    // General
    generalChecks: z.object({
      decalsWarningsPlacards: checkboxItemSchema,
      manufacturerOperatorsManual: checkboxItemSchema,
...
export default function TelehandlerFormPage() {
  ...
  const {
    ...
    setValue,
    watch,
  } = useForm<TelehandlerForm>({
    resolver: zodResolver(telehandlerFormSchema),
    defaultValues: {
      formName: "Telehandler/Forklift Pre-Use Inspection",
      ...
      formData: {
        ...
        powerOffChecks: {
          ...
          windowsGlassDoors: { ok: false, no: false, na: false, note: "" },
          hoodCoverPanels: { ok: false, no: false, na: false, note: "" },
          airFilterIndicator: { ok: false, no: false, na: false, note: "" },
          counterweightBolts: { ok: false, no: false, na: false, note: "" },
          liftingAttachments: { ok: false, no: false, na: false, note: "" },
          boomSectionsDamage: { ok: false, no: false, na: false, note: "" },
          boomAngleIndicator: { ok: false, no: false, na: false, note: "" },
          ropsCab: { ok: false, no: false, na: false, note: "" },
          frameLevelIndicator: { ok: false, no: false, na: false, note: "" },
          seatbelt: { ok: false, no: false, na: false, note: "" },
        ...
        powerOnChecks: {
          ...
          fuelLevel: { ok: false, no: false, na: false, note: "" },
          hornWarningDevices: { ok: false, no: false, na: false, note: "" },
          boomCarriage: { ok: false, no: false, na: false, note: "" },
          liftingAttachment: { ok: false, no: false, na: false, note: "" },
          driveForwardReverse: { ok: false, no: false, na: false, note: "" },
          steerLeftRight: { ok: false, no: false, na: false, note: "" },
          frameLevel: { ok: false, no: false, na: false, note: "" },
          outriggers: { ok: false, no: false, na: false, note: "" },
          otherFunctionControl: { ok: false, no: false, na: false, note: "" },
          braking: { ok: false, no: false, na: false, note: "" },
          serviceDeClutch: { ok: false, no: false, na: false, note: "" },
          parking: { ok: false, no: false, na: false, note: "" },
          otherPowerOn: { ok: false, no: false, na: false, note: "" },
        },
        generalChecks: {
          decalsWarningsPlacards: { ok: false, no: false, na: false, note: "" },
  ...
  const onSubmit = async (formData: TelehandlerForm) => {
    try {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-white rounded-md shadow-md">
      <h1 className="text-2xl font-semibold text-gray-700 mb-6">
        {id && id !== "new"
          ? "Edit Telehandler Inspection"
          : "New Telehandler Inspection"}
      </h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded-md mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <FormField
              label="Make/Model"
              error={errors.formData?.makeModel?.message}
              required
            >
              <input
                {...register("formData.makeModel")}
                className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100"
              />
            </FormField>
          </div>
        ...
        <div className="bg-gray-50 p-4 rounded-md mb-6">
          ...
          <div className="border rounded-md overflow-hidden">
            ...
            <div className="p-2">
              <CheckboxGroup
                label="1. Wheels and tires (tire pressure correct)"
              ...
              <CheckboxGroup
                label="8. Data/Capacity plate/Load Charts"
              ...
              <CheckboxGroup
                label="9. Windows/Glass/Doors"
                okName="formData.powerOffChecks.windowsGlassDoors.ok"
                noName="formData.powerOffChecks.windowsGlassDoors.no"
                naName="formData.powerOffChecks.windowsGlassDoors.na"
                noteName="formData.powerOffChecks.windowsGlassDoors.note"
                register={register}
              />

              <CheckboxGroup
                label="10. Hood Cover/Panels"
                okName="formData.powerOffChecks.hoodCoverPanels.ok"
                noName="formData.powerOffChecks.hoodCoverPanels.no"
                naName="formData.powerOffChecks.hoodCoverPanels.na"
                noteName="formData.powerOffChecks.hoodCoverPanels.note"
                register={register}
              />

              <CheckboxGroup
                label="11. Air Filter Indicator"
                okName="formData.powerOffChecks.airFilterIndicator.ok"
                noName="formData.powerOffChecks.airFilterIndicator.no"
                naName="formData.powerOffChecks.airFilterIndicator.na"
                noteName="formData.powerOffChecks.airFilterIndicator.note"
                register={register}
              />

              <CheckboxGroup
                label="12. Counterweight/Counterweights bolts"
              ...
              <CheckboxGroup
                label="13. Lifting Attachment(s)"
                okName="formData.powerOffChecks.liftingAttachments.ok"
                noName="formData.powerOffChecks.liftingAttachments.no"
                naName="formData.powerOffChecks.liftingAttachments.na"
                noteName="formData.powerOffChecks.liftingAttachments.note"
                register={register}
              />

              <CheckboxGroup
                label="14. Boom Sections-Damage, wear pads"
                okName="formData.powerOffChecks.boomSectionsDamage.ok"
                noName="formData.powerOffChecks.boomSectionsDamage.no"
                naName="formData.powerOffChecks.boomSectionsDamage.na"
                noteName="formData.powerOffChecks.boomSectionsDamage.note"
                register={register}
              />

              <CheckboxGroup
                label="15. Boom angle indicator-free movement"
                okName="formData.powerOffChecks.boomAngleIndicator.ok"
                noName="formData.powerOffChecks.boomAngleIndicator.no"
                naName="formData.powerOffChecks.boomAngleIndicator.na"
                noteName="formData.powerOffChecks.boomAngleIndicator.note"
                register={register}
              />

              <CheckboxGroup
                label="16. ROPS/Cab"
                okName="formData.powerOffChecks.ropsCab.ok"
                noName="formData.powerOffChecks.ropsCab.no"
                naName="formData.powerOffChecks.ropsCab.na"
                noteName="formData.powerOffChecks.ropsCab.note"
                register={register}
              />

              <CheckboxGroup
                label="17. Frame level indicator"
                okName="formData.powerOffChecks.frameLevelIndicator.ok"
                noName="formData.powerOffChecks.frameLevelIndicator.no"
                naName="formData.powerOffChecks.frameLevelIndicator.na"
                noteName="formData.powerOffChecks.frameLevelIndicator.note"
                register={register}
              />

              <CheckboxGroup
                label="18. Seatbelt"
                okName="formData.powerOffChecks.seatbelt.ok"
                noName="formData.powerOffChecks.seatbelt.no"
                naName="formData.powerOffChecks.seatbelt.na"
                noteName="formData.powerOffChecks.seatbelt.note"
                register={register}
              />
        ...
        <div className="bg-gray-50 p-4 rounded-md mb-6">
          ...
          <div className="border rounded-md overflow-hidden">
            ...
            <div className="p-2">
              ...
              <CheckboxGroup
                label="25. Fuel level"
                okName="formData.powerOnChecks.fuelLevel.ok"
                noName="formData.powerOnChecks.fuelLevel.no"
                naName="formData.powerOnChecks.fuelLevel.na"
                noteName="formData.powerOnChecks.fuelLevel.note"
                register={register}
              />
              ...
              <CheckboxGroup
                label="a. Boom & Carriage – raise/lower/tilt/extend/retract"
                okName="formData.powerOnChecks.boomCarriage.ok"
                noName="formData.powerOnChecks.boomCarriage.no"
                naName="formData.powerOnChecks.boomCarriage.na"
                noteName="formData.powerOnChecks.boomCarriage.note"
                register={register}
              />

              <CheckboxGroup
                label="b. Lifting Attachment – proper movement"
                okName="formData.powerOnChecks.liftingAttachment.ok"
                noName="formData.powerOnChecks.liftingAttachment.no"
                naName="formData.powerOnChecks.liftingAttachment.na"
                noteName="formData.powerOnChecks.liftingAttachment.note"
                register={register}
              />
              ...
              <CheckboxGroup
                label="e. Frame level"
                okName="formData.powerOnChecks.frameLevel.ok"
                noName="formData.powerOnChecks.frameLevel.no"
                naName="formData.powerOnChecks.frameLevel.na"
                noteName="formData.powerOnChecks.frameLevel.note"
                register={register}
              />

              <CheckboxGroup
                label="f. Outriggers"
                okName="formData.powerOnChecks.outriggers.ok"
                noName="formData.powerOnChecks.outriggers.no"
                naName="formData.powerOnChecks.outriggers.na"
                noteName="formData.powerOnChecks.outriggers.note"
                register={register}
              />

              <CheckboxGroup
                label="Other:"
                okName="formData.powerOnChecks.otherFunctionControl.ok"
                noName="formData.powerOnChecks.otherFunctionControl.no"
                naName="formData.powerOnChecks.otherFunctionControl.na"
                noteName="formData.powerOnChecks.otherFunctionControl.note"
                register={register}
              />

              <CheckboxGroup
                label="28. Braking"
                okName="formData.powerOnChecks.braking.ok"
                noName="formData.powerOnChecks.braking.no"
                naName="formData.powerOnChecks.braking.na"
                noteName="formData.powerOnChecks.braking.note"
                register={register}
              />

              <CheckboxGroup
                label="a. Service/De-clutch"
                okName="formData.powerOnChecks.serviceDeClutch.ok"
                noName="formData.powerOnChecks.serviceDeClutch.no"
                naName="formData.powerOnChecks.serviceDeClutch.na"
                noteName="formData.powerOnChecks.serviceDeClutch.note"
                register={register}
              />

              <CheckboxGroup
                label="b. Parking"
                okName="formData.powerOnChecks.parking.ok"
                noName="formData.powerOnChecks.parking.no"
                naName="formData.powerOnChecks.parking.na"
                noteName="formData.powerOnChecks.parking.note"
                register={register}
              />
        ...
        <div className="bg-gray-50 p-4 rounded-md mb-6">
          ...
          <div className="border rounded-md overflow-hidden">
            ...
            <div className="p-2">
              <CheckboxGroup
                label="32. Decals/Warnings/Placards"
                okName="formData.generalChecks.decalsWarningsPlacards.ok"
                noName="formData.generalChecks.decalsWarningsPlacards.no"
                naName="formData.generalChecks.decalsWarningsPlacards.na"
                noteName="formData.generalChecks.decalsWarningsPlacards.note"
                register={register}
              />

              <CheckboxGroup
                label="33. Manufacturer Operators Manual"
                okName="formData.generalChecks.manufacturerOperatorsManual.ok"
                noName="formData.generalChecks.manufacturerOperatorsManual.no"
                naName="formData.generalChecks.manufacturerOperatorsManual.na"
                noteName="formData.generalChecks.manufacturerOperatorsManual.note"
                register={register}
              />
        ...
        <div className="bg-gray-50 p-4 rounded-md mb-6">
          ...
          <p className="text-gray-600 mb-4">
            Report any problems found to supervisor. ALWAYS lock/tag-out unsafe
            equipment.
          </p>
            ...
            <table className="w-full">
              <thead className="bg-blue-100">
                <tr>
                  ...
                  <th className="p-2 text-left w-5/6">Comments/Action Items</th>
                </tr>
              </thead>
              <tbody>
                {fields.map((field, index) => (
                  ...
                  >
                    ...
                    <td className="p-2 border">
                      <input
                        {...register(`formData.commentItems.${index}.comment`)}
                        className="w-full p-1 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100"
                      />
                    </td>
                  </tr>
          ...
          <FormField label="">
            <div className="flex items-center gap-2">
              ...
              <label htmlFor="generatePDF" className="text-gray-700">
                Generate PDF for this Telehandler Inspection
              </label>
            </div>
          </FormField>
        )}
